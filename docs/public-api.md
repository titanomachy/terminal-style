...
finite `examples/terminal_style.nim` program is compiled by `nimble examples`
...
`tests/test_terminal_style.nim`.

The opt-in `terminal_style/palettes` module documents `TerminalPalette`,
